                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    <a class="btn btn-light" href="<?=base_url('/')?>">
                                        ...
                                        <?=($session['type'] == 'seguridad') ? 'Centro de control' : 'Dashboard'?>
                                    </a>
                                </li>
