...
<div class="container">
    ...
    <table class="table mb-5">
        <thead>
            <th class="text-center bg-light" colspan="4"><?=$session['type'] != 'seguridad' ? 'Datos del carro': ucfirst($session['type'])?></th>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><input type="color" value="<?=$car->color ?? '#ffffff'?>" disabled></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table">
        <thead>
            ...
            <th class="text-center bg-light">Estacionamiento</th>
            <th class="text-center bg-light">Lugar</th>
        ...
        <tbody>
            ...
            <tr>
                <td class="align-middle">
                    ...
                    <b># Historia de ruta <?=($index+1)?></b> <br>
                </td>
                <td class="text-center align-middle"><?=$historia['place_name']?></td>
                <td class="text-center align-middle"><?=place($historia['floor'], $historia['letter'], $historia['number'])?></td>
                <td class="text-center align-middle"><?=cute_date($historia['ra'])?></td>
                <td class="text-center align-middle"><?=$historia['rb']?></td>
                <td class="text-center align-middle"><?=cute_date($historia['rc'])?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
